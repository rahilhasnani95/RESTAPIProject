...
public class ProductDAO {
	...
	public ProductBean addNewProductAdmin(String itemname, int itemprice, int itemquantity)
	{
	...
	public ProductBean getoneprod(int itemid) {
		...
		try
		{
			...
			ProductBean prod =	em.find(ProductBean.class, itemid);
			if(prod != null)
			{
				return prod;
			}
